    ...
    <div className="mx-auto max-w-7xl px-6 py-12">
      ...
      <div className="mb-10">
        ...
        <p className="mt-3 max-w-2xl text-gray-600">
          Once you&apos;ve completed your bank transfer, upload your payment
          receipt below. Our finance team will verify your payment and begin
      ...
      <div className="grid gap-8 lg:grid-cols-3">
            ...
            {order.bankAccount ? (
              ...
              <div className="mt-6 rounded-xl bg-yellow-50 p-4">
                <p className="text-yellow-700">
                  No bank account has been linked to this order.
                </p>
              </div>
            )}
        ...
        <div className="space-y-8">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            ...
            <p className="mt-3 text-gray-600">
              Upload your bank transfer receipt to complete your payment.
            </p>

            <div className="mt-8">
              <UploadReceipt orderId={order.id} />
            </div>
          </section>
          ...
          <section className="rounded-2xl border border-blue-200 bg-blue-50 p-8">
            ...
            <ul className="mt-5 list-disc space-y-3 pl-5 text-sm text-gray-700">
              ...
              <li>
                The transferred amount should exactly match your order total.
              </li>
              <li>Accepted formats are JPG, PNG, WEBP and PDF.</li>
              <li>Maximum file size is 10 MB.</li>
              <li>
                Your payment will be verified by our finance team before the
                order is processed.
              </li>
            </ul>
          </section>
