...
export default async function AdminPage() {
  // Fetch ALL metric queries in a single parallel batch
  const [
    totalRevenue,
    totalOrders,
    totalCustomers,
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-gray-600">
            Monitor sales, customers, inventory, payments, and orders across
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 rounded-xl bg-[#DC2626] px-6 py-3 font-semibold text-white transition hover:bg-red-700"
        >
          Visit Store
          <ArrowRight size={18} />
        </Link>
      ...
      <div className="grid gap-8 xl:grid-cols-3">
        ...
        <div className="space-y-8">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            {recentOrders.filter(
              (order) => order.payment?.status === PaymentStatus.PENDING
            ).length === 0 ? (
              <div className="p-6 text-center text-gray-500">
                No pending payments in recent orders.
              </div>
            ) : (
